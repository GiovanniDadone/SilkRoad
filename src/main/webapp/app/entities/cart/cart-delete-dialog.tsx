...
export const CartDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/cart${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="silkRoadApp.cart.delete.question">
        <Translate contentKey="silkRoadApp.cart.delete.question" interpolate={{ id: cartEntity.id }}>
