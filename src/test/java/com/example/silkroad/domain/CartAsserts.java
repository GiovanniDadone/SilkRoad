...
public class CartAsserts {
     ...
     */
    public static void assertCartMapsIdRelationshipPersistedValue(Cart entityToPersist, Cart persisted) {
        // Validate the id for MapsId, the ids must be same
        assertThat(entityToPersist.getCustomer().getId()).isEqualTo(persisted.getId());
    }
